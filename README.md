...
This project builds on the work of many people. See [`docs/sources.md`](https://github.com/WPoelman/qwanqwa/blob/main/docs/sources.md) for the full source list, licenses, and terms.
